...
$_wp_last_utility_menu = 80; // The index of the last top-level menu in the utility menu group
	...
	$menu[89] = array( __('Medios DxT'), 'manage_options', 'dxtadmin.php?modulo=vista/mod_medios.php&titulo=Gestionar Medios DxT', '', 'menu-top menu-icon-media', 'menu-medios', 'div' );
		...
		$submenu['dxtadmin.php?modulo=vista/mod_medios.php&titulo=Gestionar Medios DxT'][20] = array(__('Prensas'), 'manage_options', 'dxtadmin.php?modulo=vista/mod_prensas.php&titulo=Gestionar Prensa');
		$submenu['dxtadmin.php?modulo=vista/mod_medios.php&titulo=Gestionar Medios DxT'][25] = array(__('Fotos Multiples'), 'manage_options', 'dxtadmin.php?modulo=vista/mod_imagenes_multiples.php&titulo=Carga de Fotos Multiples');

	$menu[90] = array( __('Usuarios DxT'), 'manage_options', 'dxtadmin.php?modulo=vista/mod_usuarios.php&titulo=Gestionar Usuarios DxT', '', 'menu-top menu-icon-users', 'menu-usuarios', 'div' );
		
	$menu[91] = array( __('Miscelaneos'), 'manage_options', 'dxtadmin.php?modulo=vista/mod_configuraciones.php&titulo=Gestionar Configuraciones', '', 'menu-top menu-icon-tools', 'menu-miscelaneos', 'div' );
		$submenu['dxtadmin.php?modulo=vista/mod_configuraciones.php&titulo=Gestionar Configuraciones'][10] = array(__('Publicidad'), 'manage_options', 'dxtadmin.php?modulo=vista/mod_publicidades.php&titulo=Gestionar Publicidad');
		$submenu['dxtadmin.php?modulo=vista/mod_configuraciones.php&titulo=Gestionar Configuraciones'][15] = array(__('Banner'), 'manage_options', 'dxtadmin.php?modulo=vista/mod_banner.php&titulo=Gestionar Banner');
